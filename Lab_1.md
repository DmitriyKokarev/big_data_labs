...
Скрипт в файле script_2.sh

Для 1м ключей ушло 0.02 gb
Время 2,451 сек

Для 10м ключей ушло 1.22 gb
Время 29,421 сек

3. Напишите скрипт для установки 1М хэшей, 10М хэшей.

Скрипт в файле script_3.sh

Для 1м ключей ушло 0.21 gb
Время 5.338 сек

Для 10м ключей ушло 2.79 gb
Время 76.018 сек

4. Сохраните на диск изображение и, воспользовавшись результатами из предыдущих пунктов, рассчитайте сколько таких картинок может вместить ОЗУ вашего компьютера, модифицируйте скрипт и попробуйте записать в redis в виде простых ключей.

Скрипт в файле script_4.sh

Не сгенерировав 500 тыс ключей, получили ошибку памяти:

![image](https://user-images.githubusercontent.com/95758544/145451237-2a0c0f76-9cb6-40aa-beee-12786ab8d28d.png)

на 100 тыс записей ушло 2.76 gb и 87.034 сек.
